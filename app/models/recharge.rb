class Recharge < ApplicationRecord
  ...
  def number_with_cod_area?
    operator === "Movistar" && type_payment === "Prepago" || operator === "Digitel" || operator === "Movilnet" || operator === "Cantv"
  end
  ...
  validates :cod_area, inclusion: { in: %w(0414 0424 0416 0426 0412 0212 0234 0235 0238 0239 0240 0241 0242 0243 0244 0245 0246 0247 0248 0249 0251 0252 0253 0254 0255 0256 0257 0258 0259 0261 0262 0263 0264 0265 0266 0267 0268 0269 0270 0271 0272 0273 0274 0275 0276 0277 0278 0279 0281 0282 0283 0284 0285 0286 0287 0288 0289 0291 0292 0293 0294 0295), message: "Codigo de área invalido 1", if: :number_with_cod_area? }
  validates :cod_area,  inclusion: { in: %w(0414 0424), message: "Codigo de área invalido", if: :number_is_movistar? }
  validates :cod_area, inclusion: { in: %w(0416 0426), message: "Codigo de área invalido", if: :number_is_movilnet? }
  validates :cod_area, inclusion: { in: %w(0412 0212 0234 0235 0238 0239 0240 0241 0242 0243 0244 0245 0246 0247 0248 0249 0251 0252 0253 0254 0255 0256 0257 0258 0259 0261 0262 0263 0264 0265 0266 0267 0268 0269 0270 0271 0272 0273 0274 0275 0276 0277 0278 0279 0281 0282 0283 0284 0285 0286 0287 0288 0289 0291 0292 0293 0294 0295), message: "Codigo de área invalido", if: :number_is_digitel? }
